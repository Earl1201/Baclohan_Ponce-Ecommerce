<div class="w-full max-w-[85rem] py-10 px-4 sm:px-6 lg:px-8 mx-auto">
  ...
  <div class="flex flex-col p-5 mt-4 bg-white rounded shadow-lg">
            ...
            <tbody>
              ...
              @php
                ...
                if($order->status == 'processing'){
                  $status = '<span class="px-3 py-1 text-white bg-yellow-500 rounded shadow">Shipped</span>';
                }


                if($order->status == 'shipped'){
                  $status = '<span class="px-3 py-1 text-white bg-green-500 rounded shadow">New</span>';
                }
                ...
                if($order->status == 'canceled'){
                  $status = '<span class="px-3 py-1 text-white bg-red-700 rounded shadow">Cancelled</span>';
                }
   ...
   class="inline-block px-4 py-2 text-sm font-semibold text-white bg-blue-500 rounded-md hover:bg-blue-600">
    View Details
</a>
                </td>
              </tr>
